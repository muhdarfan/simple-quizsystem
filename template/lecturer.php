   ...
   <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
     ...
     <div class="form-group">
          <label for="adminID" class="col-sm-3 control-label">Lecturer ID: </label>
          <div class="col-sm-9">
         <input name="adminID" type="text" class="form-control" id="adminID" placeholder="Enter Lecturer ID" value="<?php if(isset($_GET['edit'])) echo $editrow['*']; ?>"required/> <br />
      </div>
        </div>

        <div class="form-group">
            <label for="name" class="col-sm-3 control-label">Lecturer Name: </label>
            <div class="col-sm-9">
              <input name="name" type="text" class="form-control" id="name" placeholder="Enter Lecturer Name" value="<?php if(isset($_GET['edit'])) echo $editrow['*']; ?>" required />
            </div>
        </div>
